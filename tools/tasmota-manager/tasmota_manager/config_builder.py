...
GPIO_FUNCTION_TYPES: list[GpioType] = [
    ...
    GpioType(
        ...
        "Kimenet",
        base_codes=[21, 22, 23, 24, 25, 26, 27, 28],
...
def assign_tasmota_codes(gpio_assignments: dict[int, str]) -> dict[int, int]:
    ...
    Returns:          {gpio_number: tasmota_code}  e.g. {4: 160, 5: 161, 14: 21}
