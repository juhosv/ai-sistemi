...
> **Státusz:** Stack **felülvizsgálat alatt** – valószínű irány: **ThingsBoard** (2026-06-23)  
> **Korábbi döntés:** EMQX + FastAPI + PostgreSQL + InfluxDB (2026-05-19) – lásd alább referenciaként  
...
## ThingsBoard irány (előzetes)

A flotta-menedzsment, multi-tenant dashboard, Shared Attributes / RPC és beépített FOTA miatt a **ThingsBoard** valószínűleg felváltja a saját FastAPI + Grafana stacket az IoT rétegben. Az ESPHome eszközök MQTT-n kapcsolódnak.

→ Teljes döntési dokumentáció: [`thingsboard-dontes.md`](thingsboard-dontes.md)

Az alábbi szekciók a **2026-05-19-es FastAPI stack** tervezetét dokumentálják – hasznos referencia, ha egyes komponensek (pl. LLM microservice, Infobip SMS) mellé kell.

→ **Aktuális megvalósítási út:** [`thingsboard-megvalositas.md`](thingsboard-megvalositas.md) (ThingsBoard CE + ESPHome Docker pilot)
...
|-----------|--------|---------|
| Szenzor / eszköz | MQTT (Tasmota / ESPHome) | InfluxDB |
